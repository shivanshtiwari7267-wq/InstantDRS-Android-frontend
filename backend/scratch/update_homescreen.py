...
code = """package com.example.instantdrs_android.ui.screens
...
with open(r"C:\Users\Shivansh Tiwari\InstantDRS\InstantDRS-fronten\app\src\main\java\com\example\instantdrs_android\ui\screens\HomeScreen.kt", "w") as f:
    f.write(code)

print("Done updating HomeScreen.kt")
